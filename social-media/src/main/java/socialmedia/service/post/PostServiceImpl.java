...
import socialmedia.component.PrivacyUtils;
import socialmedia.dto.post.PostCreateDto;
import socialmedia.dto.post.PostDisplayDto;
import socialmedia.dto.post.PostUpdateDto;
import socialmedia.model.Hashtag;
import socialmedia.model.PostHashtag; // Import Entity PostHashtag
import socialmedia.model.UserHashtagInterest;
import socialmedia.model.account.User;
import socialmedia.model.social_action.*;
import socialmedia.repository.Hashtag.HashtagRepository; // Sửa package cho đúng
import socialmedia.repository.Hashtag.PostHashtagRepository; // Sửa package cho đúng
import socialmedia.repository.UserRepository;
import socialmedia.repository.post.PostCommentRepository;
import socialmedia.repository.post.PostLikeRepository;
...
import socialmedia.service.notification.PostMessage;
...
public class PostServiceImpl implements PostService {
    ...
    // ... các autowired cũ ...
    @Autowired
    private socialmedia.repository.Hashtag.UserHashtagInterestRepository interestRepo; // <-- THÊM CÁI NÀY
    @Autowired
