...
//         this.modal = null;
//
//         // Danh sách user chọn để tạo nhóm
...
//
//     updateSelectedCount() {
//         document.getElementById('cg-picked').textContent = selectedUsers.size;
//     }
//     async createGroup() {
//         const groupName = document.getElementById('cg-name').value.trim() || 'Nhóm mới';
...
//                     const formData = new FormData();
//                     formData.append('avatar', avatarFile);
//                     await fetch(`/api/chat/conversation/${result.conversation.id}/avatar`, {
//                         method: 'POST',
//                         body: formData
//                     });
//                 }
//
//                 // ✅ Sửa: dùng this.modal thay vì this.groupModal
//                 this.modal.hide();
//
//                 if (window.chatManager) {
//                     chatManager.openExistingConversation(
